...
import (
	...
	"github.com/ntlaletsi70/json-server-controller/internal/controller"

	webhookexamplev1 "github.com/ntlaletsi70/json-server-controller/internal/webhook/v1"
	//webhookv1 "github.com/ntlaletsi70/json-server-controller/internal/webhook/v1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7edf5fc1.example.com",
